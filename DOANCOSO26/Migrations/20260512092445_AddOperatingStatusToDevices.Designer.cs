...
namespace DOANCOSO26.Migrations
{
    ...
    [Migration("20260512092445_AddOperatingStatusToDevices")]
    partial class AddOperatingStatusToDevices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DOANCOSO26.Models.BusRoute", b =>
                {
                    b.HasOne("DOANCOSO26.Models.Stop", "EndStop")
                        .WithMany()
                        .HasForeignKey("EndStopId");

                    b.HasOne("DOANCOSO26.Models.Stop", "StartStop")
                        .WithMany()
            ...
            modelBuilder.Entity("DOANCOSO26.Models.Stop", b =>
                {
                    b.HasOne("DOANCOSO26.Models.BusRoute", null)
                        .WithMany("Stops")
                        .HasForeignKey("BusRouteId");
                });
