...
(function () {
    ...
    var findRoute = function (component, transConfig, transState, route) {
      return get$1(transConfig.Road, route.start).bind(function (sConfig) {
    ...
    var TransitionSchema = [
      ...
      onHandler('onFinish'),
      strictOf('Road', setOf$1(Result.value, setOf$1(Result.value, objOfOnly([optionObjOfOnly('transition', [
          strict$1('property'),
          strict$1('transitionClass')
        ])]))))
    ];

    var createBusRoute= function (Road) {
      var r = {};
      each$1(Road, function (v, k) {
    ...
    var makeMenu = function (value, items, memMenuThunk, collapsable) {
      return {
        ...
        menuBehaviours: derive$1([Transitioning.config({
            initialState: 'after',
            Road: Transitioning.createTristate('before', 'current', 'after', {
              transition: {
                property: 'transform',
